...
class _MarkersScreenState extends State<MarkersScreen> {
            ...
            trailing: Row(
              ...
              children: [
                Button(
                  ...
                  onPressed: () => _showEditDialog(marker),
                ),
  ...
  Future<void> _showEditDialog(MarkerModel? marker) async {
    ...
    final longController = TextEditingController(text: marker?.longitude.toString() ?? '');
